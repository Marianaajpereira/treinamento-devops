...
cd /var/lib/jenkins/workspace/TestePipelineMariana/08-jenkins/deploy-infra-img-java-app/terraform
terraform init
...
ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook -i hosts provisionar.yml -u jenkins --private-key /var/lib/jenkins/.ssh/id_rsa